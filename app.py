...
class App:
    def __init__(self, nome: str, endereco: str):
        ...
        # Entry
        self.txt_curso = Entry(self.janela, font="Tahoma 14", width=27)
        self.txt_curso.grid(row=3, column=1)
        ...
        self.btn_adicionar = Button(self.janela, 
                                    text='Adicionar',
                                    font='Tahoma 12 bold',
                                    fg='red',
        ...
        self.btn_editar = Button(self.janela, 
                                    text='Editar',
                                    font='Tahoma 12 bold',
                                    fg='red', 
        ...
        self.btn_excluir = Button(self.janela, 
                                    text='Excluir',
                                    font='Tahoma 12 bold',
        ...
        self.colunas = ['Matriculas', 'Nome', 'Idade', 'Curso', 'Nota']
    ...
    def excluirAluno(self):
        ...
        self.limparCampos()
        self.atualizarTabela()
        messagebox.showinfo('Sucesso!', 'Dados excluido com sucesso')

App ('Infinity School', 'Av Santos Dummont')